...
const signer = web32.eth.accounts.privateKeyToAccount(process.env.SIGNER_PRIVATE_KEY);
web32.eth.accounts.wallet.add(signer);

const contractAddress = '0x58Be5eD51e171D50C958b78ff3E9A093c287D2EB';
const vaultAddress = '0x64E21641D63Fc270FA44cC8f3e61Fe177b6a6864';
const contractABI = [
	{
		"inputs": [
			{
...
const Vault = new web32.eth.Contract(vaultABI, vaultAddress);
...
async function rewardToken(address, value) {
	console.log(address);
	
	// try {
	// 	const fromAdress = 0x66372ecb44B1d778309dF2753c986fBCb0470745;
		
	// 	const result = await Vault.methods.rewardMember(address,correctValue).send({from: fromAdress});
	// 	console.log(result);
	// } catch (error) {
	// 	console.error(error);
	// }
	const correctValue = value * 1000000000000000000;
	const method_abi = Vault.methods.rewardMember(address,correctValue).encodeABI();
	const tx = {
	  from: signer.address,
	  to: vaultAddress,
	  data: method_abi,
	...
	const gas_estimate = await web32.eth.estimateGas(tx);
	tx.gas = gas_estimate;
	const signedTx = await web3.eth.accounts.signTransaction(tx, signer.privateKey);
	console.log("Raw transaction data: " + ( signedTx).rawTransaction);
	// Sending the transaction to the network
	const receipt = await web32.eth
